    ...
    return (
      <div className="max-w-2xl mx-auto text-center py-16">
        ...
        <div className="flex gap-3 justify-center flex-wrap">
          ...
          <Link href="/community/flashcards" className="btn-ghost">All Decks</Link>
        </div>
      </div>
    );
  }
      ...
      {flipped && (
        <div className="mt-8 animate-fade-in">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <button onClick={() => review(3)} className="rounded-xl bg-yellow-50 px-4 py-3 text-sm font-medium text-yellow-700 hover:bg-yellow-100 transition border border-yellow-200 hover:border-yellow-300">
              <span className="block">Hard</span>
              <span className="text-xs opacity-60">2 — With effort</span>
            </button>
            <button onClick={() => review(4)} className="rounded-xl bg-blue-50 px-4 py-3 text-sm font-medium text-blue-700 hover:bg-blue-100 transition border border-blue-200 hover:border-blue-300">
              <span className="block">Good</span>
              <span className="text-xs opacity-60">3 — Correct</span>
            </button>
            <button onClick={() => review(5)} className="rounded-xl bg-green-50 px-4 py-3 text-sm font-medium text-green-700 hover:bg-green-100 transition border border-green-200 hover:border-green-300">
