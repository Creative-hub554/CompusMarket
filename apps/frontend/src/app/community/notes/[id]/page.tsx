...
export default function NoteEditorPage() {
  ...
  if (loading) return <div className="max-w-4xl mx-auto text-center py-16 text-slate-400">Loading...</div>;
  if (!note) return (
    <div className="max-w-4xl mx-auto text-center py-16">
      <p className="text-slate-400 mb-3">Note not found</p>
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex gap-4 text-xs text-slate-400 mb-3 flex-wrap items-center">
