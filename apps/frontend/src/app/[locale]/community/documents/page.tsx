    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          <div className="w-16 h-16 bg-gold-50 rounded-2xl flex items-center justify-center mx-auto mb-4 text-gold-400">
            ...
            return (
              <div key={doc.id} className="card relative group">
                <Link href={`/community/documents/${doc.id}`} className="block p-5">
                  <h3 className="font-semibold truncate text-slate-900 group-hover:text-gold-600 transition-colors">{doc.title}</h3>
