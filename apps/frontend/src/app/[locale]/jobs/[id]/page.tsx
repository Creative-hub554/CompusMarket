...
export default function JobDetailPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 animate-fade-in">
      ...
      <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--surface)] p-6 mt-4">
      ...
      {/* Owner view */}
      {isOwner && (
        <div className="mt-6 rounded-xl border border-[var(--border-subtle)] bg-[var(--surface)] p-6">
      ...
      {!isOwner && !session?.user && (
        <div className="mt-6 rounded-xl border border-[var(--border-subtle)] bg-[var(--surface)] p-6 text-center">
          <p className="text-slate-500 dark:text-slate-400 mb-3">{t("loginToApply")}</p>
