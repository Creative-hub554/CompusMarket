  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      {botId && (
        ...
        >
          <span className="w-12 h-12 shrink-0 rounded-full bg-gradient-to-br from-gold-500 to-gold-600 flex items-center justify-center shadow-[0_6px_18px_-6px_rgba(176,141,62,0.6)]">
