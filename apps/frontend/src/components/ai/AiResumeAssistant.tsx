...
export function AiResumeAssistant({ onImprove, currentSummary = "" }: Props) {
  ...
  return (
    <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
      <h3 className="text-sm font-semibold text-purple-800 mb-3">{t.ai.title}</h3>
        ...
        {(["summary", "experience", "cover-letter"] as const).map((m) => (
          <button
            ...
            className={`px-3 py-1 text-xs rounded-full transition ${
              mode === m ? "bg-purple-600 text-white" : "bg-white text-purple-600 border border-purple-200"
            }`}
          >
      ...
      <div className="space-y-2">
        ...
        <button
          ...
          disabled={loading}
          className="w-full rounded bg-purple-600 px-3 py-1.5 text-sm text-white hover:bg-purple-700 disabled:opacity-50 transition"
        >
